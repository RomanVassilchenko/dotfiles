{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      kwin."Move with Window to Desktop 14" = [ ];
      kwin."Move with Window to Desktop 15" = [ ];
      kwin."Move with Window to Desktop 16" = [ ];
      kwin."Move with Window to Desktop 17" = [ ];
      kwin."Move with Window to Desktop 18" = [ ];
      kwin."Move with Window to Desktop 19" = [ ];
      kwin."Move with Window to Desktop 2" = "Meta+@";
      kwin."Move with Window to Desktop 20" = [ ];
      kwin."Move with Window to Desktop 3" = "Meta+#";
      kwin."Move with Window to Desktop 4" = "Meta+$";
      kwin."Move with Window to Desktop 5" = "Meta+%";
      kwin."Move with Window to Desktop 6" = [ ];
    ...
    configFile = {
      ...
      dolphinrc.General.ViewPropsTimestamp = "2025,11,19,9,22,50.479";
      ...
      kdeglobals.General.TerminalApplication = "/nix/store/090vlklxiwr3kjbdgqby3i2br5kpaxb9-ghostty-1.2.3/bin/ghostty --gtk-single-instancex3dtrue";
      ...
      kwinrulesrc."4".desktopsrulerule = 3;
      ...
      kwinrulesrc."5".Description = "Assign OBS to Desktop 4";
      kwinrulesrc."5".desktops = "Desktop_4";
      kwinrulesrc."5".desktopsrule = 3;
      kwinrulesrc."5".desktopsrulerule = 3;
      kwinrulesrc."5".types = 1;
      kwinrulesrc."5".wmclass = "com.obsproject.Studio";
      kwinrulesrc."5".wmclasscomplete = true;
      kwinrulesrc."5".wmclassmatch = 2;
      kwinrulesrc."6".Description = "Assign Steam to Desktop 4";
      kwinrulesrc."6".desktops = "Desktop_4";
      kwinrulesrc."6".desktopsrule = 3;
      kwinrulesrc."6".desktopsrulerule = 3;
      kwinrulesrc."6".fsplevel = 4;
      kwinrulesrc."6".fsplevelrule = 2;
      kwinrulesrc."6".fsplevelrulerule = 3;
      kwinrulesrc."6".minimizerule = 2;
      kwinrulesrc."6".minimizerulerule = 3;
      kwinrulesrc."6".types = 1;
      kwinrulesrc."6".wmclass = "steam";
      kwinrulesrc."6".wmclasscomplete = false;
      kwinrulesrc."6".wmclassmatch = 1;
      kwinrulesrc."7".Description = "Assign Steam Games to Desktop 5";
      kwinrulesrc."7".desktops = "Desktop_5";
      kwinrulesrc."7".desktopsrule = 3;
      kwinrulesrc."7".desktopsrulerule = 3;
      kwinrulesrc."7".fsplevel = 4;
      kwinrulesrc."7".fsplevelrule = 2;
      kwinrulesrc."7".fsplevelrulerule = 3;
      kwinrulesrc."7".wmclass = "steam_app_";
      kwinrulesrc."7".wmclasscomplete = false;
      kwinrulesrc."7".wmclassmatch = 2;
      kwinrulesrc."8".Description = "Assign Zoom to Desktop 5";
      kwinrulesrc."8".desktops = "Desktop_5";
      kwinrulesrc."8".desktopsrule = 3;
      kwinrulesrc."8".desktopsrulerule = 3;
      kwinrulesrc."8".fsplevel = 4;
      kwinrulesrc."8".fsplevelrule = 2;
      kwinrulesrc."8".fsplevelrulerule = 3;
      kwinrulesrc."8".minimizerule = 2;
      kwinrulesrc."8".minimizerulerule = 3;
      kwinrulesrc."8".types = 1;
      kwinrulesrc."8".wmclass = "zoom";
      kwinrulesrc."8".wmclasscomplete = true;
      kwinrulesrc."8".wmclassmatch = 2;
      kwinrulesrc."9".Description = "Brave Picture-in-Picture: Float, Always On Top, All Desktops";
      kwinrulesrc."9".above = true;
      kwinrulesrc."9".aboverule = 2;
      kwinrulesrc."9".desktops = "";
      kwinrulesrc."9".desktopsrule = 2;
      kwinrulesrc."9".floatrule = 2;
      kwinrulesrc."9".ignoregeometry = false;
      kwinrulesrc."9".ignoregeometryrule = 2;
      kwinrulesrc."9".position = "1920,1080";
      kwinrulesrc."9".positionrule = 3;
      kwinrulesrc."9".size = "640,360";
      kwinrulesrc."9".sizerule = 3;
      kwinrulesrc."9".skipagerrule = 2;
      kwinrulesrc."9".skippager = true;
      kwinrulesrc."9".skiptaskbar = true;
      kwinrulesrc."9".skiptaskbarrule = 2;
      kwinrulesrc."9".title = "Picture in picture";
      ...
      spectaclerc.ImageSave.lastImageSaveLocation = "file:///home/romanv/Pictures/Screenshots/Screenshot_20251124_213125.png";
      spectaclerc.ImageSave.translatedScreenshotsFolder = "Screenshots";
      spectaclerc.VideoSave.translatedScreencastsFolder = "Screencasts";
    };
    dataFile = {
      "kate/anonymous.katesession"."Document 0".URL =
        "file:///home/romanv/Development/AdalQarau/daca-api/Science.md";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-H-Splitter = "0,1991,0";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-0-Splitter = 1001;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-1-Splitter = 1001;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-2-Splitter = 1991;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-3-Splitter = 1185;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-V-Splitter = "0,1001,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0".Sizes = 1991;
