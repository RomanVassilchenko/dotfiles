{
  programs.plasma = {
    ...
    configFile = {
      ...
      kwinrulesrc."4".Description = "Assign Zed to Desktop 2";
      kwinrulesrc."4".desktops = "Desktop_2";
      kwinrulesrc."4".desktopsrule = 3;
      kwinrulesrc."4".types = 1;
      kwinrulesrc."4".wmclass = "dev.zed.Zed";
      kwinrulesrc."4".wmclasscomplete = true;
      kwinrulesrc."4".wmclassmatch = 2;
      kwinrulesrc."5".Description = "Assign Telegram to Desktop 3";
      kwinrulesrc."5".desktops = "Desktop_3";
      kwinrulesrc."5".desktopsrule = 3;
      kwinrulesrc."5".types = 1;
      kwinrulesrc."5".wmclass = "org.telegram.desktop";
      kwinrulesrc."5".wmclasscomplete = true;
      kwinrulesrc."5".wmclassmatch = 2;
      kwinrulesrc."6".Description = "Assign Thunderbird to Desktop 4";
      ...
      kwinrulesrc."7".Description = "Assign Zoom to Desktop 5";
      kwinrulesrc."7".desktops = "Desktop_5";
      kwinrulesrc."7".desktopsrule = 3;
      kwinrulesrc."7".types = 1;
      kwinrulesrc."7".wmclass = "zoom";
      kwinrulesrc."7".wmclasscomplete = true;
      kwinrulesrc."7".wmclassmatch = 2;
      kwinrulesrc."8".Description = "Assign Camunda Modeler to Desktop 6";
      kwinrulesrc."8".desktops = "Desktop_6";
      kwinrulesrc."8".desktopsrule = 3;
      kwinrulesrc."8".types = 1;
      kwinrulesrc."8".wmclass = "camunda-modeler";
