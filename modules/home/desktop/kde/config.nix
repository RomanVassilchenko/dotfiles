{ pkgs, ... }:
{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "services/outlook-rdp.desktop"._launch = "Meta+Shift+M";
    ...
    configFile = {
      ...
      kwinrulesrc."3".wmclass =
        "com.mitchellh.ghostty|kitty|konsole|code|Zed|dev.zed.Zed|jetbrains-goland|camunda-modeler|DBeaver|Postman|com.obsproject.Studio";
